...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-python-gflags-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13173&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-python-gflags-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-python-gflags` can be installed with:

```
conda install types-python-gflags
```

It is possible to list all of the versions of `types-python-gflags` available on your platform with:
